...
# Arquivos de teste
INPUT_FILE="tests/type_check_invalid_string_to_float_test/type_check_invalid_string_to_float_test.c"
EXPECTED_FILE="tests/type_check_invalid_string_to_float_test/type_check_invalid_string_to_float_expected.txt"
...
# Executa o compilador com o arquivo de entrada e salva a saída (stdout + stderr)
cat "$INPUT_FILE" | $COMPILADOR > "$TEMP_OUTPUT" 2>&1
