...
# Arquivos de teste
INPUT_FILE="tests/type_check_invalid_float_to_int_test/type_check_invalid_float_to_int_test.c"
EXPECTED_FILE="tests/type_check_invalid_float_to_int_test/type_check_invalid_float_to_int_expected.txt"
